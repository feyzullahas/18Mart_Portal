...
_JUNE_2026 = [
    _day("2026-06-01", "1 Haziran 2026 Pazartesi",
         ["Sucuklu Yumurta", "Dere Otlu Poğaça", "Ezine Peyniri", "Siyah/Yeşil Zeytin", "Mevsim Sebzeleri Söğüş", "Çeyrek Ekmek", "500 ml Su"],
         ["Mercimek Çorba / Yayla Çorba", "Garnitürlü Tavuk Sarma / Bezelye Yemeği", "Salçalı Makarna", "Cacık", "Çeyrek Ekmek", "500 ml Su"]),
    _day("2026-06-02", "2 Haziran 2026 Salı",
         ["Patates Kızartması", "Haşlanmış Yumurta", "Beyaz Peynir", "Siyah/Yeşil Zeytin", "Elma", "Çeyrek Ekmek", "500 ml Su"],
         ["Terbiyeli Şehriye Çorba / Tarhana Çorba", "Pideli Köfte / Galeta Unlu Tavuk+Garnitür / Taze Fasulye", "Şehriyeli Pirinç Pilavı", "Çoban Salata", "Çeyrek Ekmek", "500 ml Su"]),
    _day("2026-06-03", "3 Haziran 2026 Çarşamba",
         ["Peynirli Omlet", "Çikolatalı Milföy Börek", "Kaşar Peyniri", "Siyah/Yeşil Zeytin", "Mevsim Sebzeleri Söğüş", "Çeyrek Ekmek", "500 ml Su"],
         ["Ezogelin Çorba / Sebze Çorba", "Çökertme Kebabı / Izgara Tavuk+Garnitür / Yoğurtlu Yaz Kızartma", "Domatesli Bulgur Pilavı", "Tiramisu", "Çeyrek Ekmek", "500 ml Su"]),
    _day("2026-06-04", "4 Haziran 2026 Perşembe",
         ["Karışık Pizza", "Haşlanmış Yumurta", "Krem Peynir", "Siyah/Yeşil Zeytin", "Reçel Çeşitleri", "Çeyrek Ekmek", "500 ml Su"],
         ["Salçalı Şehriye Çorba / Anadolu Çorba", "Lavaşta Tavuk Tantuni / Kabak Sandal", "Spagetti Napoliten", "Ayran", "Çeyrek Ekmek", "500 ml Su"]),
    _day("2026-06-05", "5 Haziran 2026 Cuma",
         ["Menemen", "Sade Poğaça", "Beyaz Peynir", "Siyah/Yeşil Zeytin", "Tahinli Pekmez", "Çeyrek Ekmek", "500 ml Su"],
         ["Düğün Çorba / Çeşmi Nigar Çorba", "Kuru Fasulye Yemeği / İmam Bayıldı", "Pirinç Pilavı", "Karışık Salata", "Yoğurt", "Çeyrek Ekmek", "500 ml Su"]),
